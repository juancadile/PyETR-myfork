...
test_string = "Ax Ey {Test(x)~Test2(y)~do(A(x),B(y))Test3()do()~do(),Test4(y()),0,0,P(x**y)G(34,56.6,-78.4,-4,5==4)}"  # {John()|x=* Mary()|0.004=+ Teaches(x, Fred())P(), y|4|6.2=+ Teaches(y*, John())} ^{Q(4.5*)}"
