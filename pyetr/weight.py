...
class Weight:
    ...
    def __init__(self, multiplicative: Multiset[Term], additive: Multiset[Term]) -> None:
        self.multiplicative = multiplicative
        self.additive = additive

    def __add__(self, other: "Weight") -> "Weight":
        return Weight(multiplicative=self.multiplicative + other.multiplicative, additive=self.additive + other.additive)
    ...
    def __mul__(self, other: "Weight") -> "Weight":
        if len(self.multiplicative) ==0:
            ...
            v_cross_w = Multiset[Term]([FunctionalTerm(f=XBar, t=(s_i,t_j)) for s_i in self.multiplicative for t_j in other.multiplicative])
